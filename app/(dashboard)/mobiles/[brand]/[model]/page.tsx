				...
				{filteredModelDevices.length > 0 ? (
								...
								{filteredModelDevices.map((d) => {
									...
									return (
										...
										>
											...
											<td
												className="py-4 px-6 text-right font-extrabold text-zinc-955 dark:text-zinc-100"
												suppressHydrationWarning
											>
												{d.status === "Sold"
													...
													{d.imei ? (
														<Button
															...
															onClick={() => {
																...
																router.push(
																	`/mobiles/${encodeURIComponent(brand)}/${slugify(model)}/${d.imei}`,
																);
															}}
					...
					<div className="text-center py-16 space-y-3">
						...
						<p className="text-xs text-zinc-500 dark:text-zinc-400 max-w-sm mx-auto">
							We couldn't find any individual devices matching
							your filters.
						</p>
					</div>
				)}
